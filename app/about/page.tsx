...
export const metadata: Metadata = {
  title: "About | Ben McClusky",
  metadataBase: new URL("https://benmcclusky.com/about"),
  description:
    "Learn more about my skills, experience and technical background",
  openGraph: {
    title: "About | Ben McClusky",
    url: "https://benmcclusky.com/about",
    description:
      "Learn more about my skills, experience and technical background",
    images:
            ...
            <section className="relative grid lg:grid-cols-custom grid-cols-1 gap-x-6 justify-items-center">
              <div className="order-2 lg:order-none">
                <Slide>
                  ...
                  <h2 className="font-incognito font-semibold tracking-tight sm:text-4xl text-3xl lg:leading-tight basis-1/2 mb-8">
                    {data.headline}
                  </h2>

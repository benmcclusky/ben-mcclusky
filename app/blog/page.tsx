...
export const metadata: Metadata = {
  title: "Blog | Ben McClusky",
  metadataBase: new URL("https://benmcclusky.com/blog"),
  description: "Read latest stories from Ben McClusky's Blog",
  openGraph: {
    title: "Blog | Ben McClusky",
    url: "https://benmcclusky.com/blog",
    description: "Read latest stories from Ben McClusky's Blog",
    images:
      "https://res.cloudinary.com/benmcclusky/image/upload/v1692636087/benmcclusky/blog.png",
  },
};
